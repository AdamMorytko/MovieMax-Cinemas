...
(function (h) {
    ...
    function Ia(a) {
        var b = a.aoColumns, c = a.aoData, d = n.ext.type.detect, e, f, g, j, i, h, l, q, u;
        e = 0;
    ...
    function kb(a, b, c, d) {
        ...
        if (b) for (e = b.length - 1; 0 <= e; e--) {
            ...
            for (g = q.length; f < g; f++) if ("number" === typeof q[f] && 0 <= q[f]) {
                ...
                q[f], m); else if ("string" === typeof q[f]) {
                j = 0;
    ...
    function Ka(a, b, c, d) {
        var e = [], f = b.firstChild, g, j, i = 0, h, l = a.aoColumns, q = a._rowReadObject,
    ...
    function Ja(a, b, c, d) {
        var e = a.aoData[b], f = e._aData, g = [], j, i, m, l, q, k;
        if (null === e.nTr) {
        ...
        for (var f = a.sDom.split(""), g, j, i, m, l, q, k = 0; k < f.length; k++) {
            ...
            if ("<" == j) {
                ...
                if ("'" == m || '"' == m) {
                    ...
                    -1 != l.indexOf(".") ? (m = l.split("."), i.id = m[0].substr(1, m[0].length -
    ...
    function tb(a) {
        ...
        l && i.append(h("<div/>", {"class": f.sScrollFoot}).css({
            ...
            border: 0,
            width: d ? !d ? null : w(d) : "100%"
        }).append(h("<div/>", {"class": f.sScrollFootInner}).append(m.removeAttr("id").css("margin-left",
            0).append("bottom" === j ? g : null).append(b.children("tfoot")))));
        var b = i.children(), k = b[0], f = b[1], u = l ? b[2] : null;
    ...
    function ma(a) {
        var b = a.oScroll, c = b.sX, d = b.sXInner, e = b.sY, b = b.iBarWidth, f = h(a.nScrollHead), g = f[0].style,
            ...
            m = j.children("table"), j = a.nScrollBody, l = h(j), q = j.style, u = h(a.nScrollFoot).children("div"),
            n = u.children("table"), o = h(a.nTHead), p = h(a.nTable), r = p[0], t = r.style,
            s = a.nTFoot ? h(a.nTFoot) : null, U = a.oBrowser, V = U.bScrollOversize, $b = C(a.aoColumns, "nTh"), Q, L,
    ...
    function Ha(a) {
        var b = a.nTable, c = a.aoColumns, d = a.oScroll, e = d.sY, f = d.sX, g = d.sXInner, j = c.length,
            i = na(a, "bVisible"), m = h("th", a.nTHead), l = b.getAttribute("width"), k = b.parentNode, u = !1, n, o,
            p = a.oBrowser, d = p.bScrollOversize;
        (n = b.style.width) && -1 !== n.indexOf("%") && (l = n);
        for (n = 0; n < i.length; n++) o = c[i[n]], null !== o.sWidth && (o.sWidth = Gb(o.sWidthOrig, k), u = !0);
        if (d || !u && !f && !e && j == W(a) && j == m.length) for (n = 0; n < j; n++) i = ba(a, n),
    ...
    var n = function (a) {
            ...
            this.each(function () {
                var e = {}, g = 1 < d ? Ya(e, a, !0) : a, j = 0, i, e = this.getAttribute("id"), m = !1, l = n.defaults,
                    q = h(this);
    ...
    var A = function (a, b, c) {
            a[b] !== k && (a[c] = a[b])
        }, da = /\[.*?\]$/, X = /\(\)$/, Sa = n.util.escapeRegex, wa = h("<div>")[0], Zb = wa.textContent !== k,
        ac = /<.*?>/g, Qa = n.util.throttle, Ub = [], x = Array.prototype, dc = function (a) {
    ...
    s("columns().visible()", "column().visible()",
        function (a, b) {
            var c = this, d = this.iterator("column", function (b, c) {
                ...
                var d = b.aoColumns, j = d[c], i = b.aoData, m, l, n;
                if (a !== k && j.bVisible !== a) {
                    if (a) {
    ...
    o("cells()", function (a, b, c) {
        ...
        if (b === null || b === k) return this.iterator("table", function (b) {
            var d = a, e = cb(c), f = b.aoData, g = Da(b, e), j = Sb(ka(f, g, "anCells")), i = h(Tb([], j)), m,
                n = b.aoColumns.length, o, s, r, t, w, v;
        ...
        var d = c ? {
            ...
            search: c.search
        } : {}, e = this.columns(b, d), f = this.rows(a, d), g, j, i, m, d = this.iterator("table", function (a, b) {
            var c = [];
            g = 0;
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: {sFirst: "First", sLast: "Last", sNext: "Następna", sPrevious: "Poprzednia"},
            sEmptyTable: "Brak dostępnych danych",
            sInfo: "Pokazuję _START_ do _END_ z _TOTAL_ wpisów",
            sInfoEmpty: "Pokazuję 0 do 0 z 0 wpisów",
            sInfoFiltered: "(przefiltrowano z _MAX_ wszystkich wpisów)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Pokaż _MENU_ wpisów",
            sLoadingRecords: "Ładuję...",
            sProcessing: "Procesuję...",
            sSearch: "Szukaj:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Brak wpisów dla podanej frazy"
        },
